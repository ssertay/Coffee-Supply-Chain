...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        var itemHarvested = false
        var farmerAdded = false
        ...
        assert.equal(farmerAdded, true, 'Invalid event emitted')

        await supplyChain.harvestItem(upc, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes)
        assert.equal(itemHarvested, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        assert.equal(itemProcessed, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        assert.equal(itemPacked, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(itemForSale, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(itemSold, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(itemShipped, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(retailerAdded, true, 'Invalid event emitted')

        await supplyChain.receiveItem(upc, { from: retailerID })
        assert.equal(itemReceived, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(consumerAdded, true, 'Invalid event emitted')

        await supplyChain.purchaseItem(upc, { from: consumerID })
        assert.equal(itemPurchased, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5], 7, 'Error: Missing or Invalid product state')
